 ...
 * 
 * Built: 2025-10-22T00:40:29.656Z
 */
var IqamaWidget=(()=>{var _=Object.defineProperty;var O=Object.getOwnPropertyDescriptor;var Q=Object.getOwnPropertyNames,L=Object.getOwnPropertySymbols;var J=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable;var z=(o,e,t)=>e in o?_(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t,A=(o,e)=>{for(var t in e||(e={}))J.call(e,t)&&z(o,t,e[t]);if(L)for(var t of L(e))Y.call(e,t)&&z(o,t,e[t]);return o};var Z=(o,e)=>{for(var t in e)_(o,t,{get:e[t],enumerable:!0})},K=(o,e,t,a)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Q(e))!J.call(o,r)&&r!==t&&_(o,r,{get:()=>e[r],enumerable:!(a=O(e,r))||a.enumerable});return o};var X=o=>K(_({},"__esModule",{value:!0}),o);var u=(o,e,t)=>new Promise((a,r)=>{var n=d=>{try{c(t.next(d))}catch(m){r(m)}},s=d=>{try{c(t.throw(d))}catch(m){r(m)}},c=d=>d.done?a(d.value):Promise.resolve(d.value).then(n,s);c((t=t.apply(o,e)).next())});var te={};Z(te,{WidgetManager:()=>b,initializeWidget:()=>N});var ee={googleSheetUrl:"https://docs.google.com/spreadsheets/d/14yebmqPkLo0fT0GdlXW1vq0Y4jZsYtNgbK3ijTAIQlU/edit?usp=sharing",title:"Prayer Times",location:"ICCP AZ",backgroundColor:"#1F2937",accentColor:"#E5E7EB",borderRadius:"20px",timeType:"athan",jumuahCount:1,cacheDuration:864e5,pollingInterval:864e5,debug:!1,logLevel:"normal"};function x(){return A(A({},ee),window.IqamaWidgetConfig||{})}function H(o){let t=["googleSheetUrl","title","location"].filter(a=>!o[a]);if(t.length>0)throw new Error(`Missing required configuration: ${t.join(", ")}`);return!0}var P=class{constructor(){this.config=x()}info(e,t=null){this.config.debug&&this.config.logLevel!=="minimal"&&console.log(`\u2139\uFE0F [INFO] ${e}`,t||"")}success(e,t=null){this.config.debug&&this.config.logLevel!=="minimal"&&console.log(`\u2705 [SUCCESS] ${e}`,t||"")}warn(e,t=null){console.warn(`\u26A0\uFE0F [WARNING] ${e}`,t||"")}error(e,t=null){console.error(`\u274C [ERROR] ${e}`,t||"")}debug(e,t=null){this.config.debug&&this.config.logLevel==="verbose"&&console.log(`\u{1F50D} [DEBUG] ${e}`,t||"")}},i=new P;var l={MONTH:0,DAY:1,FAJR_ATHAN:2,FAJR_IQAMA:3,SUNRISE:4,ZUHR_ATHAN:5,ZUHR_IQAMA:6,ASR_ATHAN:7,ASR_IQAMA:8,MAGHRIB_ATHAN:9,MAGHRIB_IQAMA:10,ISHA_ATHAN:11,ISHA_IQAMA:12,EMPTY:13,PRAYER_NAME:14,IQAMA_OFFSET:15,EMPTY2:16,EMPTY3:17,EMPTY4:18,EMPTY5:19,JUMAH_LABEL:20,JUMAH_START:21,JUMAH_END:22},M={FIRST:1,SECOND:2,THIRD:3},w={ATHAN:"athan",IQAMA:"iqama",BOTH:"athan and iqama"},h={TIME:"--:--",JUMAH_TIME:"--:-- - --:--",TITLE:"Prayer Times",LOCATION:"Location"},V=[/\/spreadsheets\/d\/([a-zA-Z0-9-_]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9-_]+)\/edit/,/\/spreadsheets\/d\/([a-zA-Z0-9-_]+)\/view/];function W(o){if(!o)return i.error("No URL provided to extractSheetId"),null;i.info("Extracting Sheet ID from URL",o);for(let e of V){let t=o.match(e);if(t){let a=t[1];return i.success("Sheet ID extracted",a),a}}return i.error("Could not extract Sheet ID from URL",o),null}function F(o){return!o||!o.trim()?[]:o.split(",").map(e=>e.replace(/^"/,"").replace(/"$/,"").trim())}function k(){let o=new Date;return{month:o.getMonth()+1,day:o.getDate(),year:o.getFullYear()}}function B(){let o=new Date;return o.setDate(o.getDate()+1),{month:o.getMonth()+1,day:o.getDate(),year:o.getFullYear()}}function y(o){return o!=null&&o!==""}function R(o){return`prayer_times_${o}`}var E=class{constructor(){this.sheetId=null}setSheetId(e){if(this.sheetId=W(e),!this.sheetId)throw new Error("Invalid Google Sheet URL");i.info("Sheet ID set",this.sheetId)}fetchCSV(){return u(this,null,function*(){if(!this.sheetId)throw new Error("Sheet ID not set");i.info("Fetching CSV data from Google Sheets");let e="";try{e=yield this._fetchWithGoogleViz(),i.success("Successfully fetched data using Google Visualization API")}catch(t){i.warn("Google Visualization API failed, trying direct CSV export",t.message);try{e=yield this._fetchWithDirectExport(),i.success("Successfully fetched data using direct CSV export")}catch(a){throw i.error("Both fetch methods failed",a.message),new Error("Could not fetch data from Google Sheets")}}return e})}_fetchWithGoogleViz(){return u(this,null,function*(){let e=`https://docs.google.com/spreadsheets/d/${this.sheetId}/gviz/tq?tqx=out:csv`,t=yield fetch(e,{mode:"cors",cache:"no-cache"});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);return yield t.text()})}_fetchWithDirectExport(){return u(this,null,function*(){let e=`https://docs.google.com/spreadsheets/d/${this.sheetId}/export?format=csv`,t=yield fetch(e,{mode:"cors",cache:"no-cache"});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);return yield t.text()})}validateCSVData(e){if(!e||e.trim().length===0)throw new Error("Empty CSV data received");let t=e.split(`
...
`);return i.info("CSV split into lines",t.length),this._parseJumuahTimes(t),this._parsePrayerTimes(t),i.success("CSV parsing completed",{jumuahTimes:this.jumuahTimes,prayerDays:this.prayerTimesData.length}),{jumuahTimes:this.jumuahTimes,prayerTimesData:this.prayerTimesData}}_parseJumuahTimes(e){i.info("Parsing Jumuah times from rows 2-4"),this.jumuahTimes={jumuah1:"",jumuah2:"",jumuah3:""};for(let t=M.FIRST;t<=M.THIRD;t++)if(e[t]&&e[t].trim()){let a=F(e[t]);if(a.length>=l.JUMAH_END+1){let r=a[l.JUMAH_START],n=a[l.JUMAH_END];if(y(r)&&y(n)){let s=`${r} - ${n}`;t===M.FIRST?this.jumuahTimes.jumuah1=s:t===M.SECOND?this.jumuahTimes.jumuah2=s:t===M.THIRD&&(this.jumuahTimes.jumuah3=s),i.info(`Parsed Jumuah ${t}`,s)}}}!this.jumuahTimes.jumuah1&&!this.jumuahTimes.jumuah2&&!this.jumuahTimes.jumuah3&&(i.warn("No Jumuah times found, using fallback values"),this.jumuahTimes.jumuah1=h.JUMAH_TIME,this.jumuahTimes.jumuah2=h.JUMAH_TIME,this.jumuahTimes.jumuah3=h.JUMAH_TIME)}_parsePrayerTimes(e){i.info("Parsing daily prayer times"),this.prayerTimesData=[];for(let t=4;t<e.length;t++)if(e[t]&&e[t].trim()){let a=F(e[t]);if(a.length>=l.JUMAH_END+1){let r=a[l.FAJR_ATHAN]||h.TIME,n=a[l.ZUHR_ATHAN]||h.TIME,s=a[l.ASR_ATHAN]||h.TIME,c=a[l.MAGHRIB_ATHAN]||h.TIME,d=a[l.ISHA_ATHAN]||h.TIME,m=a[l.FAJR_IQAMA]||h.TIME,p=a[l.ZUHR_IQAMA]||h.TIME,j=a[l.ASR_IQAMA]||h.TIME,I=a[l.MAGHRIB_IQAMA]||h.TIME,f=a[l.ISHA_IQAMA]||h.TIME;t===4&&(console.log("\u{1F50D} DEBUG: First row data"),console.log("Fajr Athan:",a[l.FAJR_ATHAN]),console.log("Fajr Iqama:",a[l.FAJR_IQAMA]),console.log("Dhuhr Athan:",a[l.ZUHR_ATHAN]),console.log("Dhuhr Iqama:",a[l.ZUHR_IQAMA]),console.log("Asr Athan:",a[l.ASR_ATHAN]),console.log("Asr Iqama:",a[l.ASR_IQAMA]),console.log("Maghrib Athan:",a[l.MAGHRIB_ATHAN]),console.log("Maghrib Iqama:",a[l.MAGHRIB_IQAMA]),console.log("Isha Athan:",a[l.ISHA_ATHAN]),console.log("Isha Iqama:",a[l.ISHA_IQAMA]),console.log("Total columns:",a.length),console.log("All values:",a));let v=a[l.IQAMA_OFFSET],U=a[l.PRAYER_NAME];if(console.log("\u{1F527} OFFSET DEBUG:",{prayerName:U,iqamaOffset:v,fajrAthan:r,fajrIqama:m}),v&&v.trim()!==""){let T=parseInt(v);isNaN(T)||(console.log("\u{1F527} Applying offset:",T,"minutes to",U),m=this._addMinutesToTime(r,T),p=this._addMinutesToTime(n,T),j=this._addMinutesToTime(s,T),I=this._addMinutesToTime(c,T),f=this._addMinutesToTime(d,T),console.log("\u{1F527} After offset - Fajr Iqama:",m))}let G=A({month:parseInt(a[l.MONTH]),day:parseInt(a[l.DAY]),fajrAthan:r,dhuhrAthan:n,asrAthan:s,maghribAthan:c,ishaAthan:d,fajrIqama:m,dhuhrIqama:p,asrIqama:j,maghribIqama:I,ishaIqama:f,fajr:r,dhuhr:n,asr:s,maghrib:c,isha:d},this.jumuahTimes);this.prayerTimesData.push(G)}}i.success("Daily prayer times parsed",this.prayerTimesData.length)}_addMinutesToTime(e,t){var a;if(!e||e.includes("--:--"))return h.TIME;try{let r=e.includes("AM")||e.includes("PM"),n=e.replace(/\s*(AM|PM)/i,""),s=((a=e.match(/(AM|PM)/i))==null?void 0:a[0])||"",[c,d]=n.split(":").map(Number),m=c*60+d+t;m<0?m+=24*60:m>=24*60&&(m-=24*60);let p=Math.floor(m/60),j=m%60;if(r){let I=p,f=s;return p===0?(I=12,f="AM"):p<12?f="AM":(p===12||(I=p-12),f="PM"),`${I}:${j.toString().padStart(2,"0")} ${f}`}else return`${p}:${j.toString().padStart(2,"0")}`}catch(r){return i.info("Error adding minutes to time",{timeString:e,minutes:t,error:r.message}),h.TIME}}validateParsedData(){if(!this.prayerTimesData||this.prayerTimesData.length===0)throw new Error("No prayer times data parsed");let e=this.prayerTimesData[0],t=["month","day","fajrAthan","dhuhrAthan","asrAthan","maghribAthan","ishaAthan","fajrIqama","dhuhrIqama","asrIqama","maghribIqama","ishaIqama"];for(let a of t)if(!y(e[a]))throw new Error(`Missing required field: ${a}`);return i.success("Parsed data validation passed"),!0}};var C=class{validateJumuahTimes(e){if(i.info("Validating Jumuah times"),!e)return i.error("Jumuah times object is null or undefined"),!1;let t=["jumuah1","jumuah2","jumuah3"],a=t.filter(r=>!y(e[r]));if(a.length>0)return i.error(`Missing Jumuah times: ${a.join(", ")}`),!1;for(let r of t){let n=e[r];if(n!==h.JUMAH_TIME&&!n.includes(" - "))return i.error(`Invalid Jumuah time format for ${r}: ${n}`),!1}return i.success("Jumuah times validation passed"),!0}validatePrayerData(e){if(i.info("Validating prayer data for day",e),!e)return i.error("Prayer data is null or undefined"),!1;let a=["month","day","fajr","dhuhr","asr","maghrib","isha"].filter(r=>!y(e[r]));return a.length>0?(i.error(`Missing prayer data: ${a.join(", ")}`),!1):isNaN(e.month)||isNaN(e.day)?(i.error("Month and day must be numbers"),!1):e.month<1||e.month>12?(i.error(`Invalid month: ${e.month}`),!1):e.day<1||e.day>31?(i.error(`Invalid day: ${e.day}`),!1):(i.info("Prayer data validation passed"),!0)}validatePrayerTimesArray(e){if(i.info("Validating prayer times array"),!Array.isArray(e))return i.error("Prayer times data is not an array"),!1;if(e.length===0)return i.error("Prayer times array is empty"),!1;let t=Math.min(5,e.length);for(let a=0;a<t;a++)if(!this.validatePrayerData(e[a]))return i.error(`Validation failed for prayer data at index ${a}`),!1;return i.success("Prayer times array validation passed",{totalDays:e.length,sampleValidated:t}),!0}validateConfig(e){if(i.info("Validating configuration"),!e)return i.error("Configuration is null or undefined"),!1;let a=["googleSheetUrl","title","location"].filter(r=>!y(e[r]));return a.length>0?(i.error(`Missing required configuration: ${a.join(", ")}`),!1):e.googleSheetUrl.includes("docs.google.com/spreadsheets")?isNaN(e.jumuahCount)||e.jumuahCount<1||e.jumuahCount>3?(i.error(`Invalid jumuahCount: ${e.jumuahCount}`),!1):(i.success("Configuration validation passed"),!0):(i.error("Invalid Google Sheet URL format"),!1)}validateCompleteDataSet(e){if(i.info("Validating complete data set"),!e)return i.error("Data set is null or undefined"),!1;let{jumuahTimes:t,prayerTimesData:a}=e;return!this.validateJumuahTimes(t)||!this.validatePrayerTimesArray(a)?!1:(i.success("Complete data set validation passed"),!0)}};var D=class{constructor(e=24*60*60*1e3){this.cache=new Map,this.cacheDuration=e,this.cleanupInterval=null,this._startCleanupInterval()}get(e,t=!1){let a=this.cache.get(e);if(!a)return i.info("Cache miss",e),null;let r=this._isDataFromToday(a.timestamp);return t||!r?(i.info(t?"Force refresh requested":"Data not from today",e),this.cache.delete(e),null):(i.info("Cache hit (daily data)",e),a.data)}set(e,t){let a={data:t,timestamp:Date.now()};this.cache.set(e,a),i.info("Data cached",e)}getPrayerTimes(e){let t=R(e);return this.get(t)}setPrayerTimes(e,t){let a=R(e);this.set(a,t)}clear(){this.cache.clear(),i.info("Cache cleared")}cleanup(){let e=Date.now(),t=0;for(let[a,r]of this.cache.entries())e-r.timestamp>this.cacheDuration&&(this.cache.delete(a),t++);t>0&&i.info(`Cleaned up ${t} expired cache entries`)}_isDataFromToday(e){let t=new Date().toDateString(),a=new Date(e).toDateString();return t===a}_startCleanupInterval(){this.cleanupInterval=setInterval(()=>{this.cleanup()},60*60*1e3)}};var q=class{constructor(e,t,a,r){this.dataFetcher=e,this.dataParser=t,this.validator=a,this.cacheManager=r,this.prayerTimesData=[]}fetchPrayerTimes(e=!1){return u(this,null,function*(){i.info("Starting prayer times fetch process",{forceRefresh:e});try{let t=this.cacheManager.getPrayerTimes(this.dataFetcher.sheetId,e);if(t){i.success("Using cached prayer times data"),this.prayerTimesData=t;return}i.info("Cache miss, fetching fresh data");let a=yield this.dataFetcher.fetchCSV();this.dataFetcher.validateCSVData(a);let r=this.dataParser.parseCSV(a);this.validator.validateCompleteDataSet(r),this.prayerTimesData=r.prayerTimesData,this.cacheManager.setPrayerTimes(this.dataFetcher.sheetId,this.prayerTimesData),i.success("Prayer times fetch process completed",{totalDays:this.prayerTimesData.length})}catch(t){throw i.error("Failed to fetch prayer times",t.message),t}})}getPrayerTimesForDate(e=null,t=!1){return u(this,null,function*(){yield this.fetchPrayerTimes(t);let a=e||k();i.info("Getting prayer times for date",a);let r=this.prayerTimesData.find(s=>s.month===a.month&&s.day===a.day),n={};if(r)i.success("Found prayer times for target date"),n={fajrAthan:r.fajrAthan,dhuhrAthan:r.dhuhrAthan,asrAthan:r.asrAthan,maghribAthan:r.maghribAthan,ishaAthan:r.ishaAthan,fajrIqama:r.fajrIqama,dhuhrIqama:r.dhuhrIqama,asrIqama:r.asrIqama,maghribIqama:r.maghribIqama,ishaIqama:r.ishaIqama,fajr:r.fajr,dhuhr:r.dhuhr,asr:r.asr,maghrib:r.maghrib,isha:r.isha,jumuah1:r.jumuah1,jumuah2:r.jumuah2,jumuah3:r.jumuah3,tomorrowFajr:this._getTomorrowFajr(a)};else{i.warn("No prayer times found for target date, using first row as demo data");let s=this.prayerTimesData[0];if(!s)throw i.error("No prayer data available"),new Error("No prayer data available");n={fajrAthan:s.fajrAthan||h.TIME,dhuhrAthan:s.dhuhrAthan||h.TIME,asrAthan:s.asrAthan||h.TIME,maghribAthan:s.maghribAthan||h.TIME,ishaAthan:s.ishaAthan||h.TIME,fajrIqama:s.fajrIqama||h.TIME,dhuhrIqama:s.dhuhrIqama||h.TIME,asrIqama:s.asrIqama||h.TIME,maghribIqama:s.maghribIqama||h.TIME,ishaIqama:s.ishaIqama||h.TIME,fajr:s.fajr||h.TIME,dhuhr:s.dhuhr||h.TIME,asr:s.asr||h.TIME,maghrib:s.maghrib||h.TIME,isha:s.isha||h.TIME,jumuah1:s.jumuah1||h.JUMAH_TIME,jumuah2:s.jumuah2||h.JUMAH_TIME,jumuah3:s.jumuah3||h.JUMAH_TIME,tomorrowFajr:s.fajr||h.TIME}}return i.success("Prayer times retrieved",n),n})}getPrayerTimesForToday(){return u(this,null,function*(){return yield this.getPrayerTimesForDate()})}_getTomorrowFajr(e){let t=B(),a=this.prayerTimesData.find(n=>n.month===t.month&&n.day===t.day);if(a)return a.fajr;let r=this.prayerTimesData.find(n=>n.month===e.month&&n.day===e.day);return r?r.fajr:h.TIME}getPrayerStatus(e){i.info("Calculating prayer status");let t=new Date,a=t.getHours()*60+t.getMinutes(),r=[{name:"fajr",time:this._timeToMinutes(e.fajr)},{name:"dhuhr",time:this._timeToMinutes(e.dhuhr)},{name:"asr",time:this._timeToMinutes(e.asr)},{name:"maghrib",time:this._timeToMinutes(e.maghrib)},{name:"isha",time:this._timeToMinutes(e.isha)}];r.sort((d,m)=>d.time-m.time);let n=null,s=null;for(let d=0;d<r.length;d++)a>=r[d].time&&(n=r[d],s=r[(d+1)%r.length]);n||(s=r[0]);let c={currentPrayer:(n==null?void 0:n.name)||null,nextPrayer:(s==null?void 0:s.name)||"fajr",nextPrayerTime:(s==null?void 0:s.time)||r[0].time};return i.info("Prayer status calculated",c),c}_timeToMinutes(e){if(!e||e===h.TIME)return 0;let[t,a]=e.split(" "),[r,n]=t.split(":").map(Number),s=r*60+n;return a==="PM"&&r!==12?s+=12*60:a==="AM"&&r===12&&(s-=12*60),s}refreshData(){return u(this,null,function*(){i.info("Refreshing prayer times data"),this.cacheManager.clear(),yield this.fetchPrayerTimes()})}};var $=class{constructor(){this.cardColors={}}renderWidget(e,t){i.info("Rendering widget HTML"),this.cardColors=this._getCardColors(t.backgroundColor);let a=this._getContrastingTextColor(t.backgroundColor),r=this._generateWidgetHTML(e,t,a);return i.success("Widget HTML rendered"),r}_generateWidgetHTML(e,t,a){let r=t.title||"Prayer Times",n=t.location||"Location",s;return t.timeType===w.ATHAN?s="\u{1F54C} Athan Times":t.timeType===w.IQAMA?s="\u{1F54C} Iqama Times":(t.timeType,w.BOTH,s="\u{1F54C} Prayer Times"),`
        ...
        `}_renderPrayerTimes(e,t,a){let r=[{name:"Fajr",icon:"\u{1F305}"},{name:"Dhuhr",icon:"\u2600\uFE0F"},{name:"Asr",icon:"\u{1F324}\uFE0F"},{name:"Maghrib",icon:"\u{1F307}"},{name:"Isha",icon:"\u{1F319}"}];return console.log("\u{1F3A8} RENDERER DEBUG: prayerTimes data"),console.log("fajrAthan:",e.fajrAthan),console.log("fajrIqama:",e.fajrIqama),console.log("dhuhrAthan:",e.dhuhrAthan),console.log("dhuhrIqama:",e.dhuhrIqama),console.log("timeType:",a.timeType),console.log("Full prayerTimes object:",e),a.timeType===w.BOTH?`
                <div class="prayer-times-table">
                    ...
                    ${r.map(s=>{let c=s.name.toLowerCase(),d=e[`${c}Athan`]||e[c]||"--:--",m=e[`${c}Iqama`]||"--:--";return`
            ...
            `:r.map(s=>{let c=s.name.toLowerCase(),d;return a.timeType===w.IQAMA?d=e[`${c}Iqama`]||"--:--":d=e[`${c}Athan`]||e[c]||"--:--",`
