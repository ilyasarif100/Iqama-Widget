...
`);return r.info("CSV split into lines",t.length),this._parseJumuahTimes(t),this._parsePrayerTimes(t),r.success("CSV parsing completed",{jumuahTimes:this.jumuahTimes,prayerDays:this.prayerTimesData.length}),{jumuahTimes:this.jumuahTimes,prayerTimesData:this.prayerTimesData}}_parseJumuahTimes(e){r.info("Parsing Jumuah times from rows 2-4"),this.jumuahTimes={jumuah1:"",jumuah2:"",jumuah3:""};for(let t=w.FIRST;t<=w.THIRD;t++)if(e[t]&&e[t].trim()){let a=R(e[t]);if(a.length>=l.JUMAH_END+1){let i=a[l.JUMAH_START],n=a[l.JUMAH_END];if(A(i)&&A(n)){let o=`${i} - ${n}`;t===w.FIRST?this.jumuahTimes.jumuah1=o:t===w.SECOND?this.jumuahTimes.jumuah2=o:t===w.THIRD&&(this.jumuahTimes.jumuah3=o),r.info(`Parsed Jumuah ${t}`,o)}}}!this.jumuahTimes.jumuah1&&!this.jumuahTimes.jumuah2&&!this.jumuahTimes.jumuah3&&(r.warn("No Jumuah times found, using fallback values"),this.jumuahTimes.jumuah1=h.JUMAH_TIME,this.jumuahTimes.jumuah2=h.JUMAH_TIME,this.jumuahTimes.jumuah3=h.JUMAH_TIME)}_parsePrayerTimes(e){r.info("Parsing daily prayer times"),this.prayerTimesData=[];for(let t=4;t<e.length;t++)if(e[t]&&e[t].trim()){let a=R(e[t]);if(a.length>=l.JUMAH_END+1){let i=a[l.FAJR_ATHAN]||h.TIME,n=a[l.ZUHR_ATHAN]||h.TIME,o=a[l.ASR_ATHAN]||h.TIME,c=a[l.MAGHRIB_ATHAN]||h.TIME,d=a[l.ISHA_ATHAN]||h.TIME,m=a[l.FAJR_IQAMA]||h.TIME,p=a[l.ZUHR_IQAMA]||h.TIME,v=a[l.ASR_IQAMA]||h.TIME,T=a[l.MAGHRIB_IQAMA]||h.TIME,f=a[l.ISHA_IQAMA]||h.TIME;t===4&&(console.log("\u{1F50D} DEBUG: First row data"),console.log("Fajr Athan:",a[l.FAJR_ATHAN]),console.log("Fajr Iqama:",a[l.FAJR_IQAMA]),console.log("Dhuhr Athan:",a[l.ZUHR_ATHAN]),console.log("Dhuhr Iqama:",a[l.ZUHR_IQAMA]),console.log("Asr Athan:",a[l.ASR_ATHAN]),console.log("Asr Iqama:",a[l.ASR_IQAMA]),console.log("Maghrib Athan:",a[l.MAGHRIB_ATHAN]),console.log("Maghrib Iqama:",a[l.MAGHRIB_IQAMA]),console.log("Isha Athan:",a[l.ISHA_ATHAN]),console.log("Isha Iqama:",a[l.ISHA_IQAMA]),console.log("Total columns:",a.length),console.log("All values:",a));let H=a[l.IQAMA_OFFSET];if(H&&H.trim()!==""){let x=parseInt(H);isNaN(x)||(m=this._addMinutesToTime(i,x),p=this._addMinutesToTime(n,x),v=this._addMinutesToTime(o,x),T=this._addMinutesToTime(c,x),f=this._addMinutesToTime(d,x))}let B=y({month:parseInt(a[l.MONTH]),day:parseInt(a[l.DAY]),fajrAthan:i,dhuhrAthan:n,asrAthan:o,maghribAthan:c,ishaAthan:d,fajrIqama:m,dhuhrIqama:p,asrIqama:v,maghribIqama:T,ishaIqama:f,fajr:i,dhuhr:n,asr:o,maghrib:c,isha:d},this.jumuahTimes);this.prayerTimesData.push(B)}}r.success("Daily prayer times parsed",this.prayerTimesData.length)}_addMinutesToTime(e,t){var a;if(!e||e.includes("--:--"))return h.TIME;try{let i=e.includes("AM")||e.includes("PM"),n=e.replace(/\s*(AM|PM)/i,""),o=((a=e.match(/(AM|PM)/i))==null?void 0:a[0])||"",[c,d]=n.split(":").map(Number),m=c*60+d+t;m<0?m+=24*60:m>=24*60&&(m-=24*60);let p=Math.floor(m/60),v=m%60;if(i){let T=p,f=o;return p===0?(T=12,f="AM"):p<12?f="AM":(p===12||(T=p-12),f="PM"),`${T}:${v.toString().padStart(2,"0")} ${f}`}else return`${p}:${v.toString().padStart(2,"0")}`}catch(i){return r.info("Error adding minutes to time",{timeString:e,minutes:t,error:i.message}),h.TIME}}validateParsedData(){if(!this.prayerTimesData||this.prayerTimesData.length===0)throw new Error("No prayer times data parsed");let e=this.prayerTimesData[0],t=["month","day","fajrAthan","dhuhrAthan","asrAthan","maghribAthan","ishaAthan","fajrIqama","dhuhrIqama","asrIqama","maghribIqama","ishaIqama"];for(let a of t)if(!A(e[a]))throw new Error(`Missing required field: ${a}`);return r.success("Parsed data validation passed"),!0}};var C=class{validateJumuahTimes(e){if(r.info("Validating Jumuah times"),!e)return r.error("Jumuah times object is null or undefined"),!1;let t=["jumuah1","jumuah2","jumuah3"],a=t.filter(i=>!A(e[i]));if(a.length>0)return r.error(`Missing Jumuah times: ${a.join(", ")}`),!1;for(let i of t){let n=e[i];if(n!==h.JUMAH_TIME&&!n.includes(" - "))return r.error(`Invalid Jumuah time format for ${i}: ${n}`),!1}return r.success("Jumuah times validation passed"),!0}validatePrayerData(e){if(r.info("Validating prayer data for day",e),!e)return r.error("Prayer data is null or undefined"),!1;let a=["month","day","fajr","dhuhr","asr","maghrib","isha"].filter(i=>!A(e[i]));return a.length>0?(r.error(`Missing prayer data: ${a.join(", ")}`),!1):isNaN(e.month)||isNaN(e.day)?(r.error("Month and day must be numbers"),!1):e.month<1||e.month>12?(r.error(`Invalid month: ${e.month}`),!1):e.day<1||e.day>31?(r.error(`Invalid day: ${e.day}`),!1):(r.info("Prayer data validation passed"),!0)}validatePrayerTimesArray(e){if(r.info("Validating prayer times array"),!Array.isArray(e))return r.error("Prayer times data is not an array"),!1;if(e.length===0)return r.error("Prayer times array is empty"),!1;let t=Math.min(5,e.length);for(let a=0;a<t;a++)if(!this.validatePrayerData(e[a]))return r.error(`Validation failed for prayer data at index ${a}`),!1;return r.success("Prayer times array validation passed",{totalDays:e.length,sampleValidated:t}),!0}validateConfig(e){if(r.info("Validating configuration"),!e)return r.error("Configuration is null or undefined"),!1;let a=["googleSheetUrl","title","location"].filter(i=>!A(e[i]));return a.length>0?(r.error(`Missing required configuration: ${a.join(", ")}`),!1):e.googleSheetUrl.includes("docs.google.com/spreadsheets")?isNaN(e.jumuahCount)||e.jumuahCount<1||e.jumuahCount>3?(r.error(`Invalid jumuahCount: ${e.jumuahCount}`),!1):(r.success("Configuration validation passed"),!0):(r.error("Invalid Google Sheet URL format"),!1)}validateCompleteDataSet(e){if(r.info("Validating complete data set"),!e)return r.error("Data set is null or undefined"),!1;let{jumuahTimes:t,prayerTimesData:a}=e;return!this.validateJumuahTimes(t)||!this.validatePrayerTimesArray(a)?!1:(r.success("Complete data set validation passed"),!0)}};var E=class{constructor(e=24*60*60*1e3){this.cache=new Map,this.cacheDuration=e,this.cleanupInterval=null,this._startCleanupInterval()}get(e,t=!1){let a=this.cache.get(e);if(!a)return r.info("Cache miss",e),null;let i=this._isDataFromToday(a.timestamp);return t||!i?(r.info(t?"Force refresh requested":"Data not from today",e),this.cache.delete(e),null):(r.info("Cache hit (daily data)",e),a.data)}set(e,t){let a={data:t,timestamp:Date.now()};this.cache.set(e,a),r.info("Data cached",e)}getPrayerTimes(e){let t=q(e);return this.get(t)}setPrayerTimes(e,t){let a=q(e);this.set(a,t)}clear(){this.cache.clear(),r.info("Cache cleared")}cleanup(){let e=Date.now(),t=0;for(let[a,i]of this.cache.entries())e-i.timestamp>this.cacheDuration&&(this.cache.delete(a),t++);t>0&&r.info(`Cleaned up ${t} expired cache entries`)}_isDataFromToday(e){let t=new Date().toDateString(),a=new Date(e).toDateString();return t===a}_startCleanupInterval(){this.cleanupInterval=setInterval(()=>{this.cleanup()},60*60*1e3)}};var D=class{constructor(e,t,a,i){this.dataFetcher=e,this.dataParser=t,this.validator=a,this.cacheManager=i,this.prayerTimesData=[]}fetchPrayerTimes(e=!1){return u(this,null,function*(){r.info("Starting prayer times fetch process",{forceRefresh:e});try{let t=this.cacheManager.getPrayerTimes(this.dataFetcher.sheetId,e);if(t){r.success("Using cached prayer times data"),this.prayerTimesData=t;return}r.info("Cache miss, fetching fresh data");let a=yield this.dataFetcher.fetchCSV();this.dataFetcher.validateCSVData(a);let i=this.dataParser.parseCSV(a);this.validator.validateCompleteDataSet(i),this.prayerTimesData=i.prayerTimesData,this.cacheManager.setPrayerTimes(this.dataFetcher.sheetId,this.prayerTimesData),r.success("Prayer times fetch process completed",{totalDays:this.prayerTimesData.length})}catch(t){throw r.error("Failed to fetch prayer times",t.message),t}})}getPrayerTimesForDate(e=null,t=!1){return u(this,null,function*(){yield this.fetchPrayerTimes(t);let a=e||W();r.info("Getting prayer times for date",a);let i=this.prayerTimesData.find(o=>o.month===a.month&&o.day===a.day),n={};if(i)r.success("Found prayer times for target date"),n={fajr:i.fajr,dhuhr:i.dhuhr,asr:i.asr,maghrib:i.maghrib,isha:i.isha,jumuah1:i.jumuah1,jumuah2:i.jumuah2,jumuah3:i.jumuah3,tomorrowFajr:this._getTomorrowFajr(a)};else{r.warn("No prayer times found for target date, using first row as demo data");let o=this.prayerTimesData[0];if(!o)throw r.error("No prayer data available"),new Error("No prayer data available");n={fajr:o.fajr||h.TIME,dhuhr:o.dhuhr||h.TIME,asr:o.asr||h.TIME,maghrib:o.maghrib||h.TIME,isha:o.isha||h.TIME,jumuah1:o.jumuah1||h.JUMAH_TIME,jumuah2:o.jumuah2||h.JUMAH_TIME,jumuah3:o.jumuah3||h.JUMAH_TIME,tomorrowFajr:o.fajr||h.TIME}}return r.success("Prayer times retrieved",n),n})}getPrayerTimesForToday(){return u(this,null,function*(){return yield this.getPrayerTimesForDate()})}_getTomorrowFajr(e){let t=k(),a=this.prayerTimesData.find(n=>n.month===t.month&&n.day===t.day);if(a)return a.fajr;let i=this.prayerTimesData.find(n=>n.month===e.month&&n.day===e.day);return i?i.fajr:h.TIME}getPrayerStatus(e){r.info("Calculating prayer status");let t=new Date,a=t.getHours()*60+t.getMinutes(),i=[{name:"fajr",time:this._timeToMinutes(e.fajr)},{name:"dhuhr",time:this._timeToMinutes(e.dhuhr)},{name:"asr",time:this._timeToMinutes(e.asr)},{name:"maghrib",time:this._timeToMinutes(e.maghrib)},{name:"isha",time:this._timeToMinutes(e.isha)}];i.sort((d,m)=>d.time-m.time);let n=null,o=null;for(let d=0;d<i.length;d++)a>=i[d].time&&(n=i[d],o=i[(d+1)%i.length]);n||(o=i[0]);let c={currentPrayer:(n==null?void 0:n.name)||null,nextPrayer:(o==null?void 0:o.name)||"fajr",nextPrayerTime:(o==null?void 0:o.time)||i[0].time};return r.info("Prayer status calculated",c),c}_timeToMinutes(e){if(!e||e===h.TIME)return 0;let[t,a]=e.split(" "),[i,n]=t.split(":").map(Number),o=i*60+n;return a==="PM"&&i!==12?o+=12*60:a==="AM"&&i===12&&(o-=12*60),o}refreshData(){return u(this,null,function*(){r.info("Refreshing prayer times data"),this.cacheManager.clear(),yield this.fetchPrayerTimes()})}};var $=class{constructor(){this.cardColors={}}renderWidget(e,t){r.info("Rendering widget HTML"),this.cardColors=this._getCardColors(t.backgroundColor);let a=this._getContrastingTextColor(t.backgroundColor),i=this._generateWidgetHTML(e,t,a);return r.success("Widget HTML rendered"),i}_generateWidgetHTML(e,t,a){let i=t.title||"Prayer Times",n=t.location||"Location",o;return t.timeType===M.ATHAN?o="\u{1F54C} Athan Times":t.timeType===M.IQAMA?o="\u{1F54C} Iqama Times":(t.timeType,M.BOTH,o="\u{1F54C} Prayer Times"),`
        ...
        `}_renderPrayerTimes(e,t,a){let i=[{name:"Fajr",icon:"\u{1F305}"},{name:"Dhuhr",icon:"\u2600\uFE0F"},{name:"Asr",icon:"\u{1F324}\uFE0F"},{name:"Maghrib",icon:"\u{1F307}"},{name:"Isha",icon:"\u{1F319}"}];return a.timeType===M.BOTH?`
                <div class="prayer-times-table">
                    ...
                    ${i.map(o=>{let c=o.name.toLowerCase(),d=e[`${c}Athan`]||e[c]||"--:--",m=e[`${c}Iqama`]||"--:--";return`
            ...
            `:i.map(o=>{let c=o.name.toLowerCase(),d;return a.timeType===M.IQAMA?d=e[`${c}Iqama`]||"--:--":d=e[`${c}Athan`]||e[c]||"--:--",`
